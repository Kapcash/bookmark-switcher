<template>
  <div :class="{ row: isConfirming }">
    ...
    <template v-else>
      <button type="button" :title="i18n.validate" class="flex-auto btn-icon success" @click="$emit('confirm')">
      ...
      <button type="button" :title="i18n.cancel" class="flex-auto btn-icon error" @click="isConfirming = false; $emit('cancel')">
