<template>
  <div :class="{ row: isConfirming }">
    ...
    <template v-else>
      <button type="button" :title="validateTooltip" class="btn-icon success" @click="$emit('confirm')">
      ...
      <button type="button" :title="cancelTooltip" class="btn-icon error" @click="isConfirming = false; $emit('cancel')">
