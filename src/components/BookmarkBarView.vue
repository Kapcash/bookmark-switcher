<template>
  <div class="row">
    <button type="button" :title="selectBarTitle" class="flex" :disabled="disabled" @click="$emit('select')" >{{ name }}</button>
    <div class="actions row">
      <button type="button" :title="renameTooltip" class="btn-icon" @click="$emit('edit')">
